    ...
    <MarketingShell>
      <section className="mx-auto max-w-3xl px-4 py-20 sm:px-6 lg:px-8">
        <h1 className="text-5xl font-bold tracking-tight">
          About <span className="text-gradient">Fixi AI</span>
        </h1>
        <div className="mt-8 space-y-4 text-lg text-muted-foreground">
          <p>
            We started Fixi AI because every existing background remover felt like it was built
            for someone else. Bloated editors. Watermarks. Uploads that took longer than the actual
            cutout.
          </p>
          <p>
            Fixi does one thing: it removes backgrounds with AI, fast, and gives you a clean
